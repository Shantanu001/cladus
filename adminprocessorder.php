	...
	{
		$deliverydetails="Courier Dispatched".", ".$_POST['txtCourierName'].", ".$_POST['txtTrackingId'].", ".$_POST['txtDeliveryDate'];
	...
	header("location:adminpendingorders.php");

	}
	?>
	
		<h2>Welcome <?php echo $_SESSION["cname"];?> : Process order with bill no <?php echo $_GET['billno'];?> </h2>
		<h3>Order Details :</h3>
...
?>
	...
	<br>
<h3>Please give the Courier Details </h3>	
